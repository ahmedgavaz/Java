...
public class TouristManager {
    ...
    public static void searchTourist() {
        ...
        if (type == 1) {
            ...
            for (int i = 0; i < touristList.size(); i++) {
                if (touristList.get(i).getTouristID()== integerAttribute || touristList.get(i).getVoucherID()==integerAttribute) {
                    isFound = true;
            ...
            for (int i = 0; i < touristList.size(); i++) {
                if (touristList.get(i).getTouristName().equals(attribute) ||
