...
import static Non_Simple_Version.Validators.typeOfView;

/**
 * This class executes all of the functionalities of the main menu as well as
 * the options of the submenues
 *
...
public class ShopManagement {
   ...
   /* public static void main(String[] args) {
        ...
        //!!! Acording to the testat, the business already has 3 boats, that is why I created them 
        //!!! That is why when another boat is created its ID will be 4, and not 1.
    ...
    /**
     * method that asks the user to choose one of the submenus as an option it
     * loops as long as the user inserts wrong input the input number
     * corresponds to a certain menu then asks the user to choose an option from
     * the previously chosen submenu and executes the function
     */
